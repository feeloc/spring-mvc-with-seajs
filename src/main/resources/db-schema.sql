...
insert into current_states(id, state_code, name) values(1, 'MA', 'Massachusett') ON DUPLICATE KEY UPDATE id=id;
insert into current_states(id, state_code, name) values(2, 'NH', 'New Hampshires') ON DUPLICATE KEY UPDATE id=id;
